      ...
      <div className='flex flex-row gap-4'>
        ...
        <div className="flex flex-col justify-start">
          ...
          <div className="flex justify-start">
            <p className='text-[0.75rem]'>Pubblicato da: <Link to={`/user/${post.userId}`}><span className={`${theme?.textPrimaryColor ?? "text-red-600"} cursor-pointer`}>{getUserName(post.userId)}</span></Link></p>
          </div>
        </div>
      </div>
